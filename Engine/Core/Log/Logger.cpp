...
void Logger::LogStackTrace(LogLevel level) {
  ...
  switch (level) {
  case LogLevel::Debug:
    this->Debug(logcat::StackTrace, "{}", msg);
    break;
  case LogLevel::Info:
    this->Info(logcat::StackTrace, "{}", msg);
    break;
  case LogLevel::Warn:
    this->Warn(logcat::StackTrace, "{}", msg);
    break;
  case LogLevel::Error:
    this->Error(logcat::StackTrace, "{}", msg);
    break;
  case LogLevel::Critical:
    this->Critical(logcat::StackTrace, "{}", msg);
    break;
  case LogLevel::Count:
    break;
  }
