...
void PBRRenderPipeline::PerformColorTransformPass(RHI::CommandBuffer &cmd, RHI::ImageView *target, Vector2f size) const
{
    ...
    Array<RenderAttachment> attachments{};
    RenderAttachment attachment{};
    attachment.LoadOp = AttachmentLoadOperation::DontCare;
    attachment.StoreOp = AttachmentStoreOperation::Store;
...
void PBRRenderPipeline::PerformShadowPass(RHI::CommandBuffer &Cmd)
{
    ...
    for (Int32 I = 0; I < 6; I++)
    {
        ...
        Attachment.LoadOp = AttachmentLoadOperation::Clear;
        Attachment.StoreOp = AttachmentStoreOperation::Store;
        Array<RenderAttachment> Attachments;
        Attachments.Add(Attachment);
        ...
        Depth.StoreOp = AttachmentStoreOperation::Store;
        Depth.LoadOp = AttachmentLoadOperation::Clear;
        Depth.ClearColor.r = 1.0f;
