...
public:
     ...
     * @param material
     */
    static void BakePrefilteredEnvironmentMap(const Texture2D* environment_sphere, const Texture2D* target, Material* material);
     ...
     */
    static Texture2D* BakePrefilteredEnvironmentMap(const Texture2D* environment_sphere, UInt32 width, UInt32 height, UInt32 mip_level = 1);
