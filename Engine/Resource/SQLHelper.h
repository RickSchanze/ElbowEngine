...
public:
    SQLTable() = default;
    SQLTable(const core::Type* type, SQLite::Database* db, core::StringView table_name) : type_(type), db_(db), table_name_(table_name) {}
...
public:
     ...
     */
    static core::UniquePtr<SQLTable> CreateTable(core::Ref<SQLite::Database> db, const core::Type* type, bool allow_exist = true);
