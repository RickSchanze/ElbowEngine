...
struct ImageSubresourceRange
{
    ...
    ImageSubresourceRange(/** ImageAspect */ const Int32 aspect_mask_ = -1, const UInt32 base_mip_level_ = 0,
                                             const UInt32 level_count_ = -1, const UInt32 base_array_layer_ = 0,
                                             const UInt32 layer_count_ = -1) : aspect_mask(aspect_mask_), base_mip_level(base_mip_level_),
                                                                               level_count(level_count_), base_array_layer(base_array_layer_),
...
enum class PolygonMode { Fill, Line, Point, Count };
...
IMPL_ENUM_REFL(Format)
{
    return Type::Create<Format>("Format") | refl_helper::AddEnumField("R32G32B32_Float", std::to_underlying(Format::R32G32B32_Float)) |
           ...
           refl_helper::AddEnumField("R32G32_UInt", std::to_underlying(Format::R32G32_UInt)) |
           refl_helper::AddEnumField("R8G8B8A8_UNorm", std::to_underlying(Format::R8G8B8A8_UNorm)) |
           refl_helper::AddEnumField("R8G8B8A8_SNorm", std::to_underlying(Format::R8G8B8A8_SNorm)) |
           refl_helper::AddEnumField("R8G8B8A8_UInt", std::to_underlying(Format::R8G8B8A8_UInt)) |
           refl_helper::AddEnumField("R8G8B8A8_SInt", std::to_underlying(Format::R8G8B8A8_SInt)) |
           refl_helper::AddEnumField("R8G8B8A8_SRGB", std::to_underlying(Format::R8G8B8A8_SRGB)) |
           refl_helper::AddEnumField("D32_Float_S8X24_UInt", std::to_underlying(Format::D32_Float_S8X24_UInt)) |
           refl_helper::AddEnumField("D32_Float", std::to_underlying(Format::D32_Float)) |
           refl_helper::AddEnumField("D24_UNorm_S8_UInt", std::to_underlying(Format::D24_UNorm_S8_UInt)) |
           refl_helper::AddEnumField("D16_UNorm", std::to_underlying(Format::D16_UNorm)) |
           refl_helper::AddEnumField("B8G8R8A8_SRGB", std::to_underlying(Format::B8G8R8A8_SRGB)) |
           refl_helper::AddEnumField("B8G8R8A8_UNorm", std::to_underlying(Format::B8G8R8A8_UNorm)) |
           refl_helper::AddEnumField("R16G16B16A16_Float", std::to_underlying(Format::R16G16B16A16_Float)) |
           refl_helper::AddEnumField("A2B10G10R10_UNorm", std::to_underlying(Format::A2B10G10R10_UNorm)) |
...
IMPL_ENUM_REFL(GraphicsAPI)
{
    return Type::Create<GraphicsAPI>("GraphicsAPI") | refl_helper::AddEnumField("Vulkan", std::to_underlying(GraphicsAPI::Vulkan)) |
           ...
           refl_helper::AddEnumField("Null", std::to_underlying(GraphicsAPI::Null)) |
           refl_helper::AddEnumField("Count", std::to_underlying(GraphicsAPI::Count));
}

EXEC_BEFORE_MAIN()
{
    ReflManager::GetByRef().Register<Format>(&ConstructType_Format);
    ReflManager::GetByRef().Register<PresentMode>(&ConstructType_PresentMode);
    ReflManager::GetByRef().Register<GraphicsAPI>(&ConstructType_GraphicsAPI);
}
} // namespace rhi