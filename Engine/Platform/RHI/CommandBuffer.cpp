...
void CommandBuffer::EndRender() { Enqueue<Cmd_EndRender>(); }

void CommandBuffer::SetScissor(const Rect2Df &scissor) { Enqueue<Cmd_SetScissor>(scissor); }
...
void CommandBuffer::BindIndexBuffer(Buffer *buffer_, const UInt64 offset_) { Enqueue<Cmd_BindIndexBuffer>(buffer_, offset_); }

void CommandBuffer::BindIndexBuffer(const SharedPtr<Buffer> &buffer, const UInt64 offset_) { Enqueue<Cmd_BindIndexBuffer>(buffer.get(), offset_); }
