...
struct ImageSubresourceRange {
  ...
  explicit ImageSubresourceRange(/** ImageAspect */ const int32_t aspect_mask_ = -1, const uint32_t base_mip_level_ = 0,
                                 const uint32_t level_count_ = -1, const uint32_t base_array_layer_ = 0,
                                 const uint32_t layer_count_ = -1)
      : aspect_mask(aspect_mask_), base_mip_level(base_mip_level_), level_count(level_count_),
        base_array_layer(base_array_layer_), layer_count(layer_count_) {}
};
