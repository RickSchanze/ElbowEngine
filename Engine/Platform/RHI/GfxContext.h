...
public:
   ...
   * @return
   */
  [[nodiscard]] virtual core::SharedPtr<LowShader> CreateShader(const char *code, size_t size,
                                                                core::StringView debug_name = "") = 0;
   ...
   * @return
   */
  [[nodiscard]] virtual core::SharedPtr<DescriptorSetLayout>
   ...
   * @return
   */
  [[nodiscard]] virtual core::Optional<int32_t>
  GetCurrentSwapChainImageIndexSync(Semaphore *signal_semaphore = nullptr) = 0;
   ...
   * @return
   */
  [[nodiscard]] virtual core::UniquePtr<Semaphore> CreateASemaphore(uint64_t init_value = 0,
                                                                    bool vk_timeline = true) = 0;
