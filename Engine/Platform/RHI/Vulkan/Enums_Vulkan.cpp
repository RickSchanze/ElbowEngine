...
VkVertexInputRate RHIVertexInputRateToVkVertexInputRate(platform::rhi::VertexInputRate rate) {
  switch (rate) {
  case platform::rhi::VertexInputRate::Vertex:
    return VK_VERTEX_INPUT_RATE_VERTEX;
  case platform::rhi::VertexInputRate::Instance:
...
platform::rhi::VertexInputRate VkVertexInputRateToRHIVertexInputRate(VkVertexInputRate rate) {
  ...
  case VK_VERTEX_INPUT_RATE_VERTEX:
    return platform::rhi::VertexInputRate::Vertex;
  case VK_VERTEX_INPUT_RATE_INSTANCE:
    return platform::rhi::VertexInputRate::Instance;
  default:
    return platform::rhi::VertexInputRate::Count;
  }
}
...
VkFilter RHIFilterToVkFilter(platform::rhi::FilterMode filter) {
  switch (filter) {
  case platform::rhi::FilterMode::Linear:
    return VK_FILTER_LINEAR;
  case platform::rhi::FilterMode::Nearest:
...
platform::rhi::FilterMode VkFilterToRHIFilter(VkFilter filter) {
  ...
  case VK_FILTER_LINEAR:
    return platform::rhi::FilterMode::Linear;
  case VK_FILTER_NEAREST:
    return platform::rhi::FilterMode::Nearest;
  default:
    return platform::rhi::FilterMode::Count;
  }
}
VkSamplerAddressMode RHISamplerAddressModeToVkSamplerAddressMode(platform::rhi::SamplerAddressMode address_mode) {
  switch (address_mode) {
  case platform::rhi::SamplerAddressMode::Repeat:
    return VK_SAMPLER_ADDRESS_MODE_REPEAT;
  case platform::rhi::SamplerAddressMode::MirroredRepeat:
    return VK_SAMPLER_ADDRESS_MODE_MIRRORED_REPEAT;
  case platform::rhi::SamplerAddressMode::ClampToEdge:
...
platform::rhi::SamplerAddressMode VkSamplerAddressModeToRHISamplerAddressMode(VkSamplerAddressMode address_mode) {
  ...
  case VK_SAMPLER_ADDRESS_MODE_REPEAT:
    return platform::rhi::SamplerAddressMode::Repeat;
  case VK_SAMPLER_ADDRESS_MODE_MIRRORED_REPEAT:
    return platform::rhi::SamplerAddressMode::MirroredRepeat;
  case VK_SAMPLER_ADDRESS_MODE_CLAMP_TO_EDGE:
    return platform::rhi::SamplerAddressMode::ClampToEdge;
  default:
    return platform::rhi::SamplerAddressMode::Count;
  }
}
