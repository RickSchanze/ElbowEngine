...
{
public:
    static inline core::Array<const char*> s_device_required_extensions = {
    ...
    static core::Array<const char*> GetDeviceRequiredExtensions() { return s_device_required_extensions; }

    struct SwapChainSupportDetails
    {
        vk::SurfaceCapabilitiesKHR   capabilities;
        core::Array<vk::SurfaceFormatKHR> formats;
        core::Array<vk::PresentModeKHR>   present_modes;
    };
...
public:
     ...
     * @return
     */
    static core::UniquePtr<PhysicalDevice>
    PickPhysicalDevice(Instance* instance, const core::Function<bool(const PhysicalDevice&)>& pick_func = &ThisClass::IsDeviceSuitable);
     ...
     * @return
     */
    bool CheckExtensionSupport(const core::Array<const char*>& required_extensions) const;
     ...
     * @return
     */
    vk::Format FindSupportFormat(const core::Array<vk::Format>& candidates, vk::ImageTiling tiling, vk::FormatFeatureFlagBits features) const;

    uint32_t FindMemoryType(uint32_t type_filter, vk::MemoryPropertyFlags properties) const;


    core::UniquePtr<LogicalDevice> CreateLogicalDeviceUnique();
