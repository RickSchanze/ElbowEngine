...
void Function::PointLightShadowPassVertShader::RegisterShaderVariables()
{
    ...
    REGISTER_VERT_SHADER_VAR_AUTO_StaticUniformBuffer("ubo_view", 2 * sizeof(Matrix4x4)) REGISTER_VERT_SHADER_VAR_AUTO_DynamicUniformBuffer(
        "ubo_instance", sizeof(glm::mat4) * g_engine_statistics.graphics.max_dynamic_model_uniform_buffer_count, sizeof(glm::mat4)
    ) REGISTER_PUSH_CONSTANT("camera_view", 0, RHI::Vulkan::EShaderStage::Vertex, sizeof(Matrix4x4)) REGISTER_SHADER_VAR_END()
}
