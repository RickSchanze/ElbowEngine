...
type->Internal_RegisterEnumValue(R32G32B32A32_Float ,"R32G32B32A32_Float")->SetComment("每个元素由4个32位浮点数分量构成"); \
...
type->Internal_RegisterEnumValue(R8_SRGB ,"R8_SRGB"); \
...
{ \
Type* type = Type::Create<platform::rhi::SampleCount>("platform.rhi.SampleCount")->SetComment("MSAA采样次数")->SetAttribute(Type::FlagAttribute::Flag); \
