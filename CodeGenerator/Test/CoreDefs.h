...
#define REGISTER_CLASS_NAME(FileID, LineNumber) MACRO_CONCAT3(Z_Auto_Register_Class_, FileID, LineNumber)
#define REGISTER_FUNCTION_NAME(FileID, LineNumber) MACRO_CONCAT3(Z_Auto_Register_Function_, FileID, LineNumber)
#define REGISTER_FIELD_NAME(FieldID, LineNumber) MACRO_CONCAT3(Z_Auto_Register_Field_, FieldID, LineNumber)
...
private:                                                                                                   \
    ...
    static inline const REGISTER_CLASS_NAME(FileID, LineNumber) REGISTER_FIELD_NAME(FileID, LineNumber){}; \
